...
def explore_univariate(train, cat_vars, quant_vars):
    '''
    explore each individual categorical variable by:
    takes in a dataframe and a categorical variable and returning
    a frequency table and barplot of the frequencies.

    explore each individual quantitative variable by:
    takes in a dataframe and a quantitative variable and returning
